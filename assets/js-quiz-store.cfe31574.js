...
+true;
!"Lydia";`,title:" What's the output?",options:[{text:"`1` and `false`",correct:!0,__typename:"Option"},{text:"`false` and `NaN`",correct:!1,__typename:"Option"},{text:"`false` and `false`",correct:!1,__typename:"Option"}],explanation:"The unary plus tries to convert an operand to a number. `true` is `1`, and `false` is `0`.\n\nThe string `'Lydia'` is a truthy value. What we're actually asking, is \"is this truthy value falsy?\". This returns `false`.",__typename:"Question"},{id:"5",code:`
const bird = {
  size: "small"
};
